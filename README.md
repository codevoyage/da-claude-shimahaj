...
## Environments
- Preview: https://main--excatop--aemysites.aem.page/
- Live: https://main--excatop--aemysites.aem.live/
- Block Library: https://main--excatop--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `excatop` directory in your favorite IDE and start coding :)
